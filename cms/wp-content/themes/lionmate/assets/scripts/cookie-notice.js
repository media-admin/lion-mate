	...
	cookie_groups: [
		{
			...
			cookies: [
				...
				accept: function() {
					...
					el.src = "https://www.googletagmanager.com/gtag/js?id=G-LNWL2JWT4Q";
					el.async = 1;
					...
					gtag('js', new Date());
					gtag('config', 'G-LNWL2JWT4Q', { 'anonymize_ip': true });

				},
				reject: function() {
					// Hier kommt der Opt-Out Code rein
					// Folgendes Beispiel für Google Analytics
					var disableStr = 'ga-disable-G-LNWL2JWT4Q';

					window[disableStr] = true; document.cookie = disableStr + '=true; expires=Thu, 31 Dec 2099 23:59:59 UTC; path=/';

					dywc.cookie.removeItem('_ga', '/', '.lion-mate.at');
					dywc.cookie.removeItem('_gid', '/', '.lion-mate.at');
					dywc.cookie.removeItem('_gat', '/', '.lion-mate.at');
					dywc.cookie.removeItem('_gat_gtag_G-LNWL2JWT4Q', '/', '.lion-mate.at');
				}
			}, {
