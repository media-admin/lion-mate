  ...
  class FooterMenuNavwalker extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
      $indent = str_repeat( "\t", $depth );
        $output .= $indent."<ul class=\"site-footer-navbar__navigation-list-item__submenu";
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      //Remove font awesome and is-right classes from site-footer-navbar__navigation-list-item string
      ...
      if ( ! $args['has_children'] ) {//if doesn't have children
        ...
        $item_output .= $indent . '<li class="site-footer-navbar__navigation-list-item site-footer-navbar__navigation-list-item--submenu-button has-dropdown is-hoverable" data-target="dropdown"><!-- START DROPDOWN-->' . "\n";
    ...
    private function get_item_classes( $item, $args ) {
      ...
      $classes[]   = 'site-footer-navbar__navigation-list-item';
    ...
    public static function fallback( $args ) {
      if ( current_user_can( 'edit_theme_options' ) ) {
        ...
        echo '>';
        echo '<a class="site-footer-navbar__navigation-list-item" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="">' . esc_attr( 'Add a menu', 'worldoweb' ) . '</a>';
        echo '</div>';
        if ( $container ) {
          echo '</' . esc_attr( $container ) . '>';
        }
